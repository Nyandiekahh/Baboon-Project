  ...
  return (
    <div className="newsletter">
      <header className="newsletter-header">
        ...
        <p className="subheading">Exploring the Remarkable Connection Between Baboons and Humans: A Journey Through Time</p>
      </header>
      ...
      <article className="environmental-section">
